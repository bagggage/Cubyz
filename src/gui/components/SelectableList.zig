...
const SelectCallback = *const fn(itemIdx: usize) void;
...
pub fn init(pos: Vec2f, maxHeight: f32, padding: f32, onSelect: ?SelectCallback) *SelectableList {
